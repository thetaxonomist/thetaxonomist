class Kingdom:
    def __init__(self, name, description='', cladogram=''):
        self.name = name
...
plants = Kingdom("plantae", description="Plant Kingdom", cladogram="<ul><li>Plantae<br><ul><li>Rhodophyta (red algae)</li><li>Viridiplantae (green plants)<br><ul><li>Charophyta</li><li>Chlorophyta</li><li>Embryophyta<br><ul><li>Subkingdom Bryophyta<br><ul><li>Superdivision Bryophyta<br><ul><li>Division Bryophyta</li><li>Division Anthocerotophyta</li><li>Division Marchantiophyta</li></ul></li></ul></li><li>Subkingdom Tracheophyta<br><ul><li>Superdivision Pteridophyta<br><ul><li>Division Lycopodiophyta</li><li>Division Polypodiophyta</li></ul></li><li>Superdivision Spermatophyta<br><ul><li>Clade Gymnospermae</li><li>Division Magnoliophyta</li></ul></li></ul></li></ul></li></ul></li></ul></li></ul>")
kingdoms = [plants]
prasinodermophyta = Phylum("prasinodermophyta")
prasinodermophyceae = Class("prasinodermophyceae")
palmophyllophyceae = Class("palmophyllophyceae")
prasinodermophyta.add_class(prasinodermophyceae)
prasinodermophyta.add_class(palmophyllophyceae)
chlorophyta = Phylum("chlorophyta", cladogram="<ul><li>Division Chlorophyta<br><ul><li>Subdivision Prasinophytina<ul><li>Class mamiellophyceae</li><li>Class pyramimonadophyceae</li></ul></li><li>Subdivision Chlorophytina</li></ul></li></ul>")
mamiellophyceae = Class("mamiellophyceae")
pyramimonadophyceae = Class("pyramimonadophyceae")
chlorophyta.add_class(mamiellophyceae)
chlorophyta.add_class(pyramimonadophyceae)
plants.add_phylum(prasinodermophyta)
plants.add_phylum(chlorophyta)
...
marchantiophyta = Phylum("marchantiophyta", description="liverworts, (aka hepatophyta)")
...
magnoliophyta = Phylum("magnoliophyta", description="Flowering Plant")
charophyta = Phylum("charophyta")
...
plants.add_phylum(magnoliophyta)
plants.add_phylum(charophyta)
plants.add_phylum(glaucophyta)
...
magnoliophyta.add_class(dicots)
magnoliophyta.add_class(monocots)
...
dicots.add_order(canellales)
dicots.add_order(piperales)
dicots.add_order(laurales)
dicots.add_order(magnoliales)
