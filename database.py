...
kingdoms = [plants]
bryophyta = Phylum("bryophyta", description="Non-vascular land plants. Not to be confused with Division bryophyta sensu stricto.")
...
pteridophyta = Phylum("pteridophyta", description="Vascular plants without true seeds, paraphyletic.")
lycopodiopsida = Class("lycopodiopsida", description="Lycophytes, also Division Lycopodiophyta. Also called Lycopsida")
polypodiopsida = Class("polypodiopsida", description="Ferns, also Division Polypodiophyta")
pteridophyta.add_class(lycopodiopsida)
pteridophyta.add_class(polypodiopsida)
...
spermatophyta = Phylum("spermatophyta", description="Seed plants, Also Superdivision spermatophyta. Kingdom:Plantae, Subkingdom:Tracheophyta. 259,511 extant species. Officially a Superdivision.")
...
spermatophyta.add_class(ginkgoopsida)
